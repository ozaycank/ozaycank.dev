      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-lg max-w-2xl">
            A curated selection of projects that best represent my full-stack
            engineering, architecture, and product delivery work.
          </p>
        </motion.div>
        ...
        {!hasProjects ? (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-neutral-900 dark:text-white mb-3">
              Selected Projects Currently Unavailable
            </h3>

            <p className="text-neutral-600 dark:text-neutral-400 mb-8 leading-relaxed">
              GitHub project data could not be loaded right now. You can still
              explore my public repositories directly on GitHub.
            </p>
            <a
          ...
          <div className="space-y-24 md:space-y-32">
            {projects.map((project, index) => (
              ...
              >
                ...
                {/* Content Section */}
                <div
                  className={`w-full lg:w-1/2 flex flex-col space-y-6 ${index % 2 !== 0 ? "lg:order-1" : "lg:order-2"}`}
                >
                  <div>
